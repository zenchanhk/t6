...
class QDataFrameModel(QAbstractTableModel):
    ...
    def sort(self, column, order=Qt.AscendingOrder):
        ...
        if ascending:
            ...
            if np.issubdtype(data.dtype, np.dtype(np.float64)):
    ...
    def _emit_all_data_changed(self):
        ...
        self.headerDataChanged.emit(
            Qt.Vertical, 0, len(self.data_frame.columns) - 1)
...
class DataFrameTable(RawWidget):
    ...
    def create_widget(self, parent):
        ...
        """
        tbl =  QDataFrameTableView.from_data_frame(
